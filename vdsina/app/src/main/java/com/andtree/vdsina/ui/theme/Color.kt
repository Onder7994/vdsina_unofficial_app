...
// Main color
val White = Color(0xFFF3EEF0)
val UnselectedGray = Color(0xFFA0A0A0)
//val MainBlue = Color(0xFF6B7FEB)
val Red = Color(0xFFC92835)
val Green = Color(0xFF4AE912)
val CardBackgroundColor = Color(0xFFFFFFFF)
val MainBlack = Color(0xFF1A1919)
val AlertDialogFocusedColor = Color(0xFFDFDADA)

// generated by https://material-foundation.github.io/material-theme-builder/

val primaryLight = Color(0xFF6B7FEB)
...
val backgroundLight = Color(0xFFF3EEF0)
